...
Schemas.JOB_AREAS = ["Mechanical engineering", "Chemical engineering",
    "Programming", "Science", "Design", "Marketing", "Communications", "Sales", "Other"];
...
Schemas.Job = new SimpleSchema({
    ...
    jobArea: {
        type: String,
        label: "Job Area",
        allowedValues: Schemas.JOB_AREAS,
        autoform: {
            type: "select2",
            firstOption: "(Empty) All",
            options: () => Schemas.JOB_AREAS.map(el => {
                return {label: el, value: el}
            }),
            select2Options: function () {
                return {theme: "bootstrap"}
